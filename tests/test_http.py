...
from browser_use_lite._http import (
    SyncHttpClient,
    _parse_retry_after,
    _raise_for_status,
)
from browser_use_lite.exceptions import (
    AuthenticationError,
    CloudBrowserError,
    NetworkError,
    ProviderError,
...
class TestSyncHttpClient:
    ...
    def test_auth_header_set(self):
        ...
        assert client._client.headers["X-Browser-Use-API-Key"] == "my-api-key"
        client.close()
    ...
    def test_retries_on_500(self):
        ...
        ), patch("browser_use_lite._http.time.sleep"):
            result = client.request("GET", "/test")
    ...
    def test_retries_on_429_with_retry_after(self):
        ...
        with patch.object(
            ...
            "request",
            side_effect=[fail_resp, ok_resp],
        ), patch("browser_use_lite._http.time.sleep") as mock_sleep:
            result = client.request("GET", "/test")
